...
function Toggle({ id }) {
	const { openId, close, open, setPosition, setToggleElement } =
...
function List({ children, id }) {
	const { openId, close, position, toggleElement } = useContext(MenusContext);
	...
	useEffect(() => {
		function handleClick(e) {
			...
			// Close if clicking outside the menu list
